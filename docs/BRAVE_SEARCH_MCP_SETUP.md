...
Brave Search MCP enhances IFMOS classification by using web search to disambiguate low-confidence and ambiguous classifications.
...
- **Free Tier**: 2,000 queries/month (sufficient for IFMOS)
...
## Step 5: IFMOS Integration Script
...
### Free Tier Limits
- **Queries**: 2,000/month
- **IFMOS Usage**: ~150-200 queries (for 150 unknown files)
